...
describe("stageChunkText", () => {
  it("stages a whole added hunk and leaves later hunks unstaged", () => {
    ...
    expect(stageChunkText(original, current, beta)).toBe("alpha\nBETA\ngamma\ndelta\n");
  });
...
describe("overviewTicks", () => {
  it("maps added, deleted, and modified hunks", () => {
    ...
    const modTicks = overviewTicks(Text.of("alpha\nBETA\ngamma\n".split("\n")), modified, null);
...
describe("stateWithGitOriginal", () => {
  it("decorates added, deleted, and modified hunks", () => {
    ...
    expect(() => stateWithGitOriginal("alpha\nbeta\ngamma\n", "alpha\ngamma\n")).not.toThrow();
    expect(() => stateWithGitOriginal("alpha\ngamma\n", "alpha\nbeta\ngamma\n")).not.toThrow();
  ...
  it("rebuilds hunks when git original changes without a doc edit", () => {
    ...
    const updated = stateWithGitOriginalUpdated(matching, "alpha\nbeta\ngamma\n");
