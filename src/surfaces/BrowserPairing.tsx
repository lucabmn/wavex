    ...
    <div className="flex min-h-screen items-center justify-center bg-background-base px-6 py-10">
      ...
      >
        ...
        <textarea
          ...
          className="mt-4 w-full resize-none rounded-md border border-edge bg-content/5 px-2.5 py-2 font-mono text-[12px] text-content/85 placeholder:text-content/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        />
        ...
        <div className="mt-4 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="ui-fill ui-focus flex items-center gap-1.5 rounded-lg px-3.5 py-1.5 text-[12px] font-medium disabled:opacity-40"
          >
