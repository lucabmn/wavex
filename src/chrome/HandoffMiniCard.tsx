      ...
      >
        <div className="flex w-full flex-col text-left">
          <span className="flex min-w-0 items-center gap-1.5">
            ...
            <span className="min-w-0 truncate text-[11.5px] text-content/50">Handoff</span>
          </span>
          ...
          {card.request ? (
            <span className="mt-1 line-clamp-1 text-[11.5px] text-content/45">{card.request}</span>
          ) : null}
          {files ? (
            <span className="mt-1 text-[11.5px] leading-4 text-content/45">{files}</span>
          ) : null}
        </div>
        {onDismiss ? (
          <button
