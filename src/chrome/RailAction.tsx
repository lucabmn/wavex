...
export function RailAction({
  ...
  return (
    <button
      ...
      className={`ui-row ui-focus relative flex h-8 w-full items-center gap-2.5 rounded-lg px-2 text-left transition-colors ${
...
export function RailSearch({
  ...
  return (
    <button
      ...
      disabled={!onClick}
      aria-label={ariaLabel ?? label}
      className={`ui-focus relative flex h-8 w-full items-center gap-2 rounded-lg border border-edge px-2 text-left transition-colors ${
        active
