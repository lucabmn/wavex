...
export function SecondOpinionCard({ card }: Props) {
  ...
  return (
    <div className="min-w-0 font-sans">
      ...
      <div className="mt-1 flex min-w-0 items-center gap-1.5 text-[11.5px] leading-4 text-faint">
      ...
      {files ? <div className="mt-1 text-[11.5px] leading-4 text-faint">{files}</div> : null}
    </div>
  );
}
