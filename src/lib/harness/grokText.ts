...
export async function stopGrokTextPrompt(childId?: string, hostIdArg?: HostId): Promise<void> {
...
export function warmupGrokText(cwd: string, hostIdArg?: HostId): Promise<void> {
