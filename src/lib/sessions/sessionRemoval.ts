...
import { buildDeterministicHandoff, completeHandoff, isPreparingHandoff } from "../handoff";
import { isFilesystemTab, type WorkspaceTab } from "../workspace/layout";
import type { Session } from "../session";
import {
  removeSessionFromWorkspace,
  type SessionWorkspaceRemoval,
} from "./sessionWorkspaceLifecycle";
import type { WorkspaceTabCloseScope } from "../workspace/workspaceTabGroups";
