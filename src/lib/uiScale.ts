...
const UI_SCALE_KEY = "wavex.uiScale";
...
export const UI_SCALE_CHANGE_EVENT = "wavex:uiscalechange";
...
export async function applyUiScale(value: number) {
  ...
  if (typeof window !== "undefined") {
    window.dispatchEvent(new CustomEvent<number>(UI_SCALE_CHANGE_EVENT, { detail: next }));
  }
  return next;
}
